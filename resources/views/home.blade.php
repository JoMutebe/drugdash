...
<div class="row top_tiles">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body" id="condoms">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body" id="stockout-tallies"></div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body" id="stockout-comparisons"></div>
      </div>
    </div>
  </div>
  ...
  <script>
   ...
   Highcharts.chart('stockout-tallies', {
    chart: {
      type: 'column'
    },
    title: {
   ...
   Highcharts.chart('stockout-comparisons', {
    chart: {
      type: 'column'
    },
    title: {
